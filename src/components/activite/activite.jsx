  ...
  return (
    <div>
      <div className="activite-info center">
        ...
        <br />
        <a href="https://www.vendee-tourisme.com/" target="_blank" className="home-button">Vendée Tourisme</a>
      </div>
      <div className="activite-cards">
        <img className="activite-img" src="../../../assets/img/IMG_7932.JPG" alt="" />
        <ActiviteCard number="01" title="Plage des Sables" text={textSables} />
        <img className="activite-img" src="../../../assets/img/DJI_0007.JPG" alt="" />
        <ActiviteCard number="02" title="Marais Salants" text={textSalants} />
        <ActiviteCard number="03" title="Île Penotte" text={textIles} />
        <img className="activite-img" src="../../../assets/img/activite/IMG_7972.JPG" alt="" />
        <ActiviteCard number="04" title="Plage du Veillon" text={textVeillon} />
        <img className="activite-img" src="../../../assets/img/activite/IMG_8112.JPG" alt="" />
        <img className="activite-img" src="../../../assets/img/activite/IMG-20200709-WA0018.jpg" alt="" />
        <ActiviteCard number="05" title="Le Puy du Fou" text={textFou} />
        <img className="activite-img" src="../../../assets/img/activite/IMG_7953.JPG" alt="" />
